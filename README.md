...
Utilisez la commande suivante dans ce cas:

`docker run -itd -p 50070:50070 -p 8088:8088 -p 7077:7077 -p 16010:16010 --name hadoop-master --hostname hadoop-master genieouz/hadoop-setup:1.0`
